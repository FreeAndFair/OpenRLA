...
Proof. 
  ...
  rewrite <- sumList_support_bool. simpl. 
  rewrite sumList_inverse. SearchAbout sumList.
  rewrite evalDist_left_ident_eq at 2.
  SearchAbout evalDist. 
  f_equal.
  Check sumList_support_bool. SearchAbout (Comp bool).

  erewrite beqRat_trans.
